...
ggsave(
    ...
    file = "plot_rigid_uniform.png", dpi = 600, width = 500, height = 250, units = "mm"
)
ggsave(plot.nearest(data_both_rigid_uniform), file = "plot_uniform_nearest.png", dpi = 600, width = 500, height = 250, units = "mm")
...
ggsave(
    ...
    file = "plot_rigid_gaussian.png", dpi = 600, width = 500, height = 250, units = "mm"
)
ggsave(plot.nearest(data_both_rigid_gaussian), file = "plot_gaussian_nearest.png", dpi = 600, width = 500, height = 250, units = "mm")
...
ggsave(
    ...
    file = "plot_affine_uniform.png", dpi = 600, width = 500, height = 250, units = "mm"
)
...
ggsave(
    ...
    file = "plot_affine_gaussian.png", dpi = 600, width = 500, height = 250, units = "mm"
)
...
data_affine_affine_both = rbind(
    ...
    data.frame(data_affine_affine_gaussian, layout = "GROUPED")
)
data_affine_affine_both$layout = as.factor(data_affine_affine_both$layout)
data_affine_affine_both$i = as.factor(data_affine_affine_both$i)
data_affine_affine_both$n = as.factor(data_affine_affine_both$n)
ggsave(
    grid_arrange_shared_legend(
        plot.coverage(data_affine_affine_both, fill_by = "layout", facet_by = "method"),
        plot.area(data_affine_affine_both, fill_by = "layout", facet_by = "method", TRUE)
    ),
    file = "plot_affine_affine_both.png", dpi = 600, width = 500, height = 250, units = "mm"
)
...
data_rigid_rigid_both = rbind(
    ...
    data.frame(data_rigid_rigid_gaussian, layout = "GROUPED")
)
...
ggsave(
    ...
    file = "plot_rigid_rigid_both.png", dpi = 600, width = 500, height = 250, units = "mm"
)
...
data_both_rigid_both = rbind(
    ...
    data.frame(data_both_rigid_gaussian, layout = "GROUPED")
)
...
ggsave(
    ...
    file = "plot_rigid.png", dpi = 600, width = 500, height = 250, units = "mm"
)
